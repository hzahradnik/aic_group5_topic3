...
public class SentimentResult implements Serializable
{
	...
	public double getCalculatedResult()
	{
		...
		return (positive + neutral *0.5D)/getTotalResults();
	}
	...
	public String toString()
	{
		...
		return String.format("Query=\"%1$s\" was evaluated as %2$s (%7$s%%) or %8$s (positive = %3$s, neutral = %4$s, negative = %5$s). Analyzed %6$s tweets.",
										query,
