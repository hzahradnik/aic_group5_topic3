...
public class Task {
	...
	public static TaskThread randomTask(List<String> tasks,
			ResultsDatabase resultsCallback) {

		Random r = new Random();
		Task task = new Task(tasks.get(r.nextInt(tasks.size())));
	...
	public void analyze(ResultsDatabase resultCallback) {
		resultCallback.startTask(theTaskWord);
